...
!!! info
    ...
    **Source Code Repository:** [https://github.com/redhat-appstudio-mjf/chatbot-aug27-2025-2](https://github.com/redhat-appstudio-mjf/chatbot-aug27-2025-2)

    **GitOps Repository:** [https://github.com/redhat-appstudio-mjf/chatbot-aug27-2025-2-gitops](https://github.com/redhat-appstudio-mjf/chatbot-aug27-2025-2-gitops)

# **Usage**

To access the chatbot-aug27-2025-2 application that was deployed using the Software Template, complete the following instructions:
...
If you are interested in seeing the deployed Kubernetes resources, all resources were deployed into your chosen namespace of chatbot-aug27-2025-2. You can access this namespace through the web console or via your CLI.
